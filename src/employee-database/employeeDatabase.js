    ...
    return (
        <div className={`${CommonStyles.card}`}>
            <div className="py-4">
                ...
                <p className={`${Styles.subheading}`}>Select the checkbox of the field you want to be Required.</p>
            </div> 
            <div className="container-fluid">
                <div className="row">
                    <div className="col-md-6 p-2">
                        <p className={`${Styles.cardlabel} mb-0 py-1`}>All Fields</p>
                        <div className={Styles.cardBody} style={{height: '300px', overflowY: 'scroll'}}>
                            <div className="d-flex align-items-center mb-3" style={{borderBottom: `1px solid ${Colors.TEXTCOLOR}`}}>
                                <div className="px-2">
                                    <i className="fa fa-search" aria-hidden="true"></i>
                                </div>
                                <div className="px-2 flex-grow-1">
                                    <input type="text" placeholder="Search Field Here" className={Styles.formControl} />
                                </div>
                            </div> 
                                ...
                                {FieldTabsList.map((fieldName) => {
                                    return (
                                        <div className="p-2" key={fieldName}>
                                            <FieldTabs click={() => handelSelectedTab(fieldName)}>{fieldName}</FieldTabs>
                                        </div>
                                    )
                                })}
                            </div>
                    ...
                    <div className="col-md-6 p-2">
                        <p className={`${Styles.cardlabel} mb-0 py-1`}>Selected Fields</p>
                        <div className={Styles.cardBody} style={{height: '300px', overflowY: 'scroll'}}>
                            <div className="d-flex align-items-center pb-2" style={{borderBottom: `1px solid ${Colors.TEXTCOLOR}`}}>
                                <div className="px-2">
                                    <p className={`mb-0 ${Styles.fieldHeading}`}>Field Name</p>
                                </div>
                            ...
                            {selectedFields.map((fieldName) => {
                                return (
                                    <div className="p-2" key={fieldName}>
                                        <FiledList fieldName={fieldName} click={handelRemoveField} />
                                    </div>
                                )    
                            })}
                        </div>
